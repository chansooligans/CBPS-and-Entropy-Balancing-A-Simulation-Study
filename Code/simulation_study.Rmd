...
(3) Standard Normally Distributed Covariates + 3 count covariates:
...
(4) Standard Normally Distributed Covariates + 3 count covariates (non-linear propensity score model):
...
ggarrange(true_prs_density[[1]],true_prs_density[[2]],true_prs_density[[5]],true_prs_density[[6]], ncol=2, nrow=2, common.legend = TRUE, legend="bottom")
```
...
```{r echo = FALSE}
ggarrange(love.plots.var[[1]],love.plots.var[[2]], ncol=1, nrow=2, common.legend = TRUE, legend="right")
ggarrange(love.plots.var[[5]],love.plots.var[[6]], ncol=1, nrow=2, common.legend = TRUE, legend="right")
